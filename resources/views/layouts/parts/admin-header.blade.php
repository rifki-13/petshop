            ...
            <li  x-data="{ showPopupMenu : false }">
                ...
                <div class="relative" x-show="showPopupMenu">
                    <div class="absolute z-20 w-full p-3 mt-3 right-1 space-y-2 overflow-hidden transform shadow-lg bg-gradient-to-br from-white to-gray-50 md:w-48 rounded-md ring-1 ring-black ring-opacity-5">
                        <a href="/#" class="block px-4 py-2 text-sm text-gray-600 capitalize cursor-pointer hover:bg-blue-800 rounded-xl hover:text-gray-100"> Profile </a>
                        <a href="/#" class="block px-4 py-2 text-sm text-gray-600 capitalize hover:bg-blue-800 rounded-xl hover:text-gray-100"> Logout </a>
                    </div>
                </div>
            </li>
            {{-- <li>
