    ...
    <div class="sm:w-5/12 mb-10 container mx-auto">
        <div class="container mx-auto h-full lg:p-10">
            <header class="container mx-auto px-4 py-2 mt-10 lg:flex items-center h-full lg:mt-0">
                <div class="w-full">
                    <h1 class="text-2xl font-bold lg:text-4xl">Create your <span class="text-green-700">Account</span></h1>
                    <div class="w-24 h-2 bg-blue-700 my-4"></div>
                    <div class="mt-10">
                        <form method="POST" action="{{ route('register') }}">
                            @csrf
                            <div class="flex flex-col mb-5">
                                <label for="name" class="mb-1 text-xs tracking-wide text-gray-600">Your Name</label>
                                <div class="relative">
                                    <div
                            ...
                            <a href="#" target="_blank"
                                ...
                                <span class="ml-2">You don't have an account?
                                    <a href="{{ route('register') }}"
                                        class="text-xs ml-2 text-green-500 font-semibold">Register now</a></span>
                            </a>
                        </div> --}}
                    </div>
                </div>
