...
<div class="sm:w-5/12 mb-10 container mx-auto">
    <div class="container mx-auto h-full lg:p-10">
        <header class="container mx-auto px-4 py-2 mt-10 lg:flex items-center h-full lg:mt-0">
            <div class="w-full">
                <h1 class="text-2xl font-bold lg:text-4xl">Reset <span class="text-red-600">Password</span></h1>
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="flex w-full">
                            <button type="submit"
                                ...
                                <span class="mr-2 uppercase">Send reset password link</span>
                                <span>
                    ...
                    <div class="flex justify-center items-center mt-6">
                        <a href="#" target="_blank"
                           class="inline-flex items-center text-gray-700 font-medium text-xs text-center">
                                <span class="ml-2">Remember your password?
                                    <a href="{{ route('login') }}" class="text-xs ml-2 text-green-500 font-semibold">Login</a></span>
                        </a>
                    </div>
                </div>
            </div>
